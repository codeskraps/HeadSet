...
<tt>v2    -Theme for newer devices
          ...
          -Trigger only if usb connected option
<tt>v1.15 -Stop HeadSet from launching multiple times
<tt>v1.14 -Removing launchFeature and bug fix with packageManager
<tt>v1.13 -Bug fix
<tt>v1.12 -Launch home screen on disconnect
<tt>v1.11 -Added donation activity
<tt>v1.10 -Donation menu button added and icon changed
