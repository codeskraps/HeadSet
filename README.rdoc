...
<tt>v2.1  -Bug fixes</tt>
<tt>v2    -Theme for newer devices
          -Multiple apps select
          -Trigger only if usb connected option</tt>
<tt>v1.15 -Stop HeadSet from launching multiple times</tt>
<tt>v1.14 -Removing launchFeature and bug fix with packageManager</tt>
<tt>v1.13 -Bug fix</tt>
<tt>v1.12 -Launch home screen on disconnect</tt>
<tt>v1.11 -Added donation activity</tt>
<tt>v1.10 -Donation menu button added and icon changed</tt>
...
<tt>https://play.google.com/store/apps/details?id=com.codeskraps.headset</tt>
